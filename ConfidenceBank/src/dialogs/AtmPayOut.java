...
public class AtmPayOut extends JDialog{
	...
	public AtmPayOut(Bank reference, Atm ref) {
		this();
		this.bank = reference;
		this.atm = ref;
	}
	...
	public AtmPayOut() {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							atm.setLblInfo(bank.useCard(pin, amount));
							setVisible(false);
							dispose();
							
						}
						catch(Exception ex) {
							atm.setLblInfo("Wrong input!");
						}
					}
				});
		...
		btnCfAmnt.setBounds(219, 50, 188, 23);
